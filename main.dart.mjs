...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1329: x0 => new WeakRef(x0),
      _1330: x0 => x0.deref(),
      _1336: () => globalThis.WeakRef,
      _1341: s => JSON.stringify(s),
      _1342: s => printToConsole(s),
      ...
      _1355: (a, i) => a.push(i),
      _1359: a => a.pop(),
      _1360: (a, i) => a.splice(i, 1),
      _1361: (a, s) => a.join(s),
      _1362: (a, s, e) => a.slice(s, e),
      _1365: a => a.length,
      _1367: (a, i) => a[i],
      _1368: (a, i, v) => a[i] = v,
      ...
      _1371: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
...
"TransitionRoute",
"DartPerformanceMode.",
"Todays Appointments will be shown here",
"Home Page",
"_buildScope",
"Name",
"Medical Condition",
...
":00",
"Registered Patients",
"Search patients by name or email or phone number",
"max",
"FlexFit.",
"SmartQuotesType.",
"endGlyphHeight",
...
"Error saving patient. Contact help team.\n ",
"Please fill all required fields",
"age",
"Date of Birth",
"Patient's date of birth in dd/mm/yyyy",
"[\\d\\/]",
...
"Medical Condition details must be at least 5 characters long",
...
"booked",
"AppointmentStatus.",
"Selected time is not in working hours: ",
